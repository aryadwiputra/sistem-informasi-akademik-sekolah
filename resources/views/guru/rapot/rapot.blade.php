                                                        ...
                                                        @if ($data->nilai($data->id))
                                                            <td class="ctr">
                                                                ...
                                                                <div class="text-center">
                                                                    {{ $data->nilai($data->id)->p_nilai }}</div>
                                                            </td>
                                                            <td class="ctr">
                                                                <div class="text-center">
                                                                    {{ $data->nilai($data->id)->p_predikat }}</div>
                                                            </td>
                                                            <td class="ctr">
                                                            ...
                                                            @else
                                                                <td class="ctr">
                                                                    <input type="text" name="nilai" maxlength="2"
                                                                        ...
                                                                        data-ids="{{ $data->id }}" autofocus
                                                                        autocomplete="off">
                                                                    <div class="knilai_{{ $data->id }} text-center">
                                                                    </div>
                                                                </td>
                                                                <td class="ctr">
                                                                    <input type="text" name="predikat"
                                                                        ...
                                                                        disabled>
                                                                    <div class="kpredikat_{{ $data->id }} text-center">
                                                                    </div>
                                                                </td>
                                                                <td class="ctr">
