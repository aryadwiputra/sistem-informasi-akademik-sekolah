                                        ...
                                        <tbody>
                                            @foreach ($mapel as $val => $data)
                                                <tr>
                                                    ...
                                                    <td class="ctr">
                                                        {{ $data->ulangan($val) ? $data->ulangan($val)['ulha_1'] : ' - ' }}
                                                    </td>
                                                    <td class="ctr">
                                                        {{ $data->ulangan($val) ? $data->ulangan($val)['ulha_2'] : ' - ' }}
                                                    </td>
                                                    <td class="ctr">
                                                        {{ $data->ulangan($val) ? $data->ulangan($val)['uts'] : ' - ' }}
                                                    </td>
                                                    <td class="ctr">
                                                        {{ $data->ulangan($val) ? $data->ulangan($val)['ulha_3'] : ' - ' }}
                                                    </td>
                                                    <td class="ctr">
                                                        {{ $data->ulangan($val) ? $data->ulangan($val)['uas'] : ' - ' }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
