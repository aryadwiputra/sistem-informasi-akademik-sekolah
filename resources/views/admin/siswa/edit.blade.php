                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('siswa.update', $siswa->id) }}" method="post">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="no_induk" name="no_induk"
                                                value="{{ $siswa->no_induk }}" class="form-control" readonly>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="jk" name="jk"
                                                ...
                                                <option value="L" @if ($siswa->jk == 'L') selected @endif>
                                                    Laki-Laki</option>
                                                <option value="P" @if ($siswa->jk == 'P') selected @endif>
                                                    Perempuan</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select id="kelas_id" name="kelas_id"
                                                ...
                                                @foreach ($kelas as $data)
                                                    <option value="{{ $data->id }}"
                                                        @if ($siswa->kelas_id == $data->id) selected @endif>
                            ...
                            <div class="card-footer">
                                <a href="{{ route('siswa.index') }}" name="kembali" class="btn btn-default"
                                    id="back">Kembali</a>
