                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('guru.update', $guru->id) }}" method="post">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <select id="mapel_id" name="mapel_id"
                                                ...
                                                @foreach ($mapel as $data)
                                                    <option value="{{ $data->id }}"
                                                        @if ($guru->mapel_id == $data->id) selected @endif>
                                                        {{ $data->nama_mapel }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="telp" name="telp"
                                                onkeypress="return inputAngka(event)" value="{{ $guru->telp }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="jk" name="jk"
                                                ...
                                                <option value="L" @if ($guru->jk == 'L') selected @endif>
                                                    Laki-Laki
                                                </option>
                                                <option value="P" @if ($guru->jk == 'P') selected @endif>
                                                    Perempuan
                                                </option>
                                            </select>
                                        </div>
                            ...
                            <div class="card-footer justify-content-between">
                                <a href="{{ route('guru.index') }}" name="kembali" class="btn btn-default" id="back">
                                    Kembali</a>
